...
llava: examples/llava/llava.cpp examples/llava/llava-utils.h examples/llava/clip.cpp examples/llava/clip.h common/stb_image.h ggml.o console.o llama.o $(COMMON_DEPS) $(OBJS)
